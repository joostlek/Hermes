...
//                .andExpect(jsonPath("$.owner.id", is(location.getCompany().getId())))
//                .andExpect(jsonPath("$.owner.firstName", is(location.getCompany().getFirstName())))
//                .andExpect(jsonPath("$.owner.lastName", is(location.getCompany().getLastName())))
//                .andExpect(jsonPath("$.owner.email", is(location.getCompany().getEmail())));
//    }
//
//    @Test
...
//                .andExpect(jsonPath("$.name", is(location.getName())))
//                .andExpect(jsonPath("$.owner.id", is(location.getCompany().getId().intValue())))
//                .andExpect(jsonPath("$.owner.firstName", is(location.getCompany().getFirstName())))
//                .andExpect(jsonPath("$.owner.lastName", is(location.getCompany().getLastName())))
//                .andExpect(jsonPath("$.owner.email", is(location.getCompany().getEmail())));
//    }
