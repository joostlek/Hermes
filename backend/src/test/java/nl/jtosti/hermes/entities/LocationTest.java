...
//
//    private Company user = new User("Alex", "Jones", "Alex.jones@jones.com", new ArrayList<>(), new ArrayList<>());
//
//    @Test
...
//        assertThat(location.getCompany()).isNull();
...
//        assertThat(location.getScreens()).hasSize(0);
//        assertThat(location.getCompany()).isEqualTo(user);
//    }
//
//    @Test
