...
export class PromotionService {
  promotions: Promotion[] = [
    new Promotion(1, "Promotion 1", {'name': 'TYPE 1', 'id': 1}, {'name':'Joost Lekkerkerker', 'id': 1}, [{'name': "asd"}, {'name': "qwe"}], {name: 'CAFETARIA VIKAS', id: 1}, '19-05-2018'),
    new Promotion(2, "Promotion 2", {'name': 'TYPE 1', 'id': 1}, {'name':'Joost Lekkerkerker', 'id': 1}, [{'name': "asd"}, {'name': "qwe"}], {name: 'CAFETARIA VIKAS', id: 1}, '19-05-2018'),
    new Promotion(3, "Promotion 3", {'name': 'TYPE 1', 'id': 1}, {'name':'Joost Lekkerkerker', 'id': 1}, [{'name': "asd"}, {'name': "qwe"}], {name: 'CAFETARIA VIKAS', id: 1}, '19-05-2018'),
    new Promotion(4, "Promotion 4", {'name': 'TYPE 1', 'id': 1}, {'name':'Joost Lekkerkerker', 'id': 1}, [{'name': "asd"}, {'name': "qwe"}], {name: 'CAFETARIA VIKAS', id: 1}, '19-05-2018'),
  ];
  constructor() { }
  ...
  addPromotion(name: string, type: number, location: number, user: number, startDate: Date): Promotion {
    ...
    this.promotions.push(new Promotion(id, name, {'name': 'TYPE 1', 'id': 1}, {'name':'Joost Lekkerkerker', 'id': 1}, [], {name: 'CAFETARIA VIKAS', id: 1}, '19-05-2018'));
