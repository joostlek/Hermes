...
public class LoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (loginRequest.getPassword().equals("test")) {
            ...
            resp.setStatus(200);
            resp.getOutputStream().println("{\"id\":1,\"firstName\":\"Joost\",\"middleName\":\"\",\"lastName\":\"Lekkerkerker\", \"email\":\"\", \"roles\":[\"SUPAUSA\"], \"locations\":[{\"name\":\"Cafetaria Vikas\", \"id\":1}], \"promotions\":[{\"id\":1, \"name\": \"New Promotion\"}], \"images\":[], \"phoneNumber\":\"\", \"street\":\"\", \"houseNumber\":\"\", \"zipCode\":\"\", \"city\":\"\", \"country\":\"\"}");
        } else {
            resp.setStatus(404);
        }
    }
